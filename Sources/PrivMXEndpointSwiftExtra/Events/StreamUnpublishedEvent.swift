...
/// A helper extension for `StreamUnpublishedEvent` to conform to the `PMXEvent` protocol.
/// This extension is designed to assist with event channels type conversions,
/// as channels are identified by strings in the Low-Level Endpoint.
extension privmx.endpoint.stream.StreamUnpublishedEvent: PMXStreamEvent, @unchecked  Sendable {

	/// Returns the event type as a string.
	///
	/// This method returns the constant string `"StreamUnpublished"`, identifying the type
	/// of this event as `StreamUnpublished`.
	/// - Returns: A `String` representing the event type, in this case, `"StreamUnpublished"`.
