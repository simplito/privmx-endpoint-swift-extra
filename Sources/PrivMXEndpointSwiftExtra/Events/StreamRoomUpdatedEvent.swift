...
/// A helper extension for `StreamRoomUpdatedEvent` to conform to the `PMXEvent` protocol.
/// This extension is designed to assist with event channels type conversions,
/// as channels are identified by strings in the Low-Level Endpoint.
extension privmx.endpoint.stream.StreamRoomUpdatedEvent: PMXStreamEvent, @unchecked  Sendable {

	/// Returns the event type as a string.
	///
	/// This method returns the constant string `"StreamRoomUpdated"`, identifying the type
	/// of this event as `StreamRoomUpdated`.
	/// - Returns: A `String` representing the event type, in this case, `"StreamRoomUpdated"`.
	...
	public func handleWith(
		...
		Task{
			await cb(StreamRoomUpdatedSubscriptionPayload.streamRoomUpdated(data: data))
		}
	}
