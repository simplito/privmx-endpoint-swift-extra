...
extension privmx.endpoint.inbox.InboxUpdatedEvent: PMXEvent {
	...
	///
	/// This method returns the constant string `"inboxUpdated"`, identifying the type
	/// of this event as `inboxUpdated`.
	/// - Returns: A `String` representing the event type, in this case, `"inboxUpdated"`.
...
extension privmx.endpoint.inbox.InboxUpdatedEvent: @unchecked  Sendable {
}
