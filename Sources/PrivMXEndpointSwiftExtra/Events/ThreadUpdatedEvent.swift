...
extension privmx.endpoint.thread.ThreadUpdatedEvent: PMXEvent {
	...
	///
	/// This method returns the constant string `"threadUpdated"`, identifying the type
	/// of this event as `threadUpdated`.
	/// - Returns: A `String` representing the event type, in this case, `"threadUpdated"`.
...
extension privmx.endpoint.thread.ThreadUpdatedEvent: @unchecked  Sendable {
}
