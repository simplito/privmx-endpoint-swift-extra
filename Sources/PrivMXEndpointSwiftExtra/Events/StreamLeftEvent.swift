...
/// A helper extension for `StreamLeftEvent` to conform to the `PMXEvent` protocol.
/// This extension is designed to assist with event channels type conversions,
/// as channels are identified by strings in the Low-Level Endpoint.
extension privmx.endpoint.stream.StreamLeftEvent: PMXStreamEvent, @unchecked  Sendable {

	/// Returns the event type as a string.
	///
	/// This method returns the constant string `"StreamLeft"`, identifying the type
	/// of this event as `StreamLeft`.
	/// - Returns: A `String` representing the event type, in this case, `"StreamLeft"`.
