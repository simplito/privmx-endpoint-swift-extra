...
/// A helper extension for `KvdbCreatedEvent` to conform to the `PMXEvent` protocol.
/// This extension is designed to assist with event channels type conversions,
/// as channels are identified by strings in the Low-Level Endpoint.
extension privmx.endpoint.kvdb.KvdbCreatedEvent: PMXEvent, @unchecked Sendable {
	...
	///
	/// This method returns the constant string `"kvdbCreated"`, identifying the type
	/// of this event as `kvdbCreated`.
	/// - Returns: A `String` representing the event type, in this case, `"kvdbCreated"`.
